...
import { profiles } from './memberProfile';
...
const AboutNew = ()=> {
    ...
    <div className="container aboutus">
       ...
       <div className="row mb-5">
            ...
            {
                profiles.map((profile)=><div key={profile.id} className="col-md-3 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src={profile.url} className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">{profile.team}</h5>
                        <div className="card-text text-black-50">{profile.title} <p className="float-right">{profile.experience} years</p>
                        </div>
                        <h6 className="mt-5">Connect as at:</h6>
